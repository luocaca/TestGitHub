...
//public class FlowerDetailActivity_bak extends NeedSwipeBackActivity {
...
//						// TODO Auto-generated method stub
//						super.onStart();
//						if (!FlowerDetailActivity_bak.this.isFinishing()) {
//							hud = KProgressHUD
//									.create(FlowerDetailActivity_bak.this)
//									.setStyle(
...
//						}
//						Toast.makeText(FlowerDetailActivity_bak.this,
...
//						FlowerDetailActivity_bak.this, position, ossImagePaths);
//
...
//								FlowerDetailActivity_bak.this, StoreActivity.class);
...
//						Intent toLoginActivity = new Intent(
//								FlowerDetailActivity_bak.this, LoginActivity.class);
//						startActivityForResult(toLoginActivity, 4);
//						overridePendingTransition(R.anim.slide_in_left,
//								R.anim.slide_out_right);
//						return;
//					}
//					Intent toDActivity4 = new Intent(FlowerDetailActivity_bak.this,
//							DActivity5.class);
...
//					}
//					if (isOwner == true) {
//						Toast.makeText(FlowerDetailActivity_bak.this, "自家商品不可购买",
//								Toast.LENGTH_SHORT).show();
//						return;
//					}
//					if (stock <= 0) {
//						Toast.makeText(FlowerDetailActivity_bak.this, "库存不足",
//								Toast.LENGTH_SHORT).show();
//						return;
//					}
//					if (!cartExist) {
//						popwin = new EditP2(FlowerDetailActivity_bak.this, ""
//								+ stock, FlowerDetailActivity_bak.this);
...
//						FlowerDetailActivity_bak.this, SaveSeedlingActivity.class);
...
//					imm.hideSoftInputFromWindow(FlowerDetailActivity_bak.this
...
//									"msg");
//							if (!"".equals(msg)) {
//								Toast.makeText(FlowerDetailActivity_bak.this, msg,
//										Toast.LENGTH_SHORT).show();
//							}
//							if ("1".equals(code)) {
//								JSONObject jsonObject2 = JsonGetInfo
...
//											FlowerDetailActivity_bak.this, "下架日期："
//													+ closeDate + "可延期至："
//													+ maxCloseDate,
//											FlowerDetailActivity_bak.this, maxDays);
//									popwin.setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_ADJUST_RESIZE);
...
//			new AlertDialog(FlowerDetailActivity_bak.this).builder()
